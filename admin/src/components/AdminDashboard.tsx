      ...
      if (analyticsResponse.ok) {
        ...
        if (analyticsData.success) {
          ...
          setStats({
            ...
            activeUsers: overview.total_buyers + overview.total_sellers,
            totalProducts: overview.total_products,
            pendingProducts: 0, // Not in analytics yet
            totalRFQs: overview.total_rfqs,
            activeRFQs: 0, // Not in analytics yet
            totalOrders: overview.total_orders,
            revenue: overview.total_revenue
          });
          
          // Set recent users from analytics
          if (analyticsData.data.recent_users) {
            setUsers(analyticsData.data.recent_users.map((u: any) => ({
              id: u.id,
              email: u.email,
              role: u.role,
