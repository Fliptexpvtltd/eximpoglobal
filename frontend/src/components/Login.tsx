...
import { Globe, ShieldCheck, Truck, TrendingUp, Smartphone, Eye, EyeOff } from 'lucide-react';
...
export function Login({ onLogin, onSignup, onGoogleAuth, onMobilePreview, onForgotPassword, isModal = false }: LoginProps) {
  ...
  // Check if running on iOS (iPhone/iPad) — hide Google Sign-In on iOS per App Store guideline 4.8
  ...
  useEffect(() => {
    // Skip Google Sign-In on iOS devices entirely
    if (isIOS) return;
            ...
            <div>
              ...
              <div className="relative">
                <input
                  ...
                  className="w-full px-5 py-4 text-lg sm:text-base border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent pr-12"
