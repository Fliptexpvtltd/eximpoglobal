...
import { Upload, FileText, Check, AlertCircle, Building2, CreditCard, FileCheck, ArrowLeft, ArrowRight } from 'lucide-react';
...
export function VerificationPage({ user, onBack, onComplete }: VerificationPageProps) {
  ...
  return (
    <div className="max-w-6xl mx-auto py-8 px-4">
      ...
      <div className="mb-8">
        ...
        <div>
          <h1 className="text-3xl font-bold text-gray-900">Complete Verification</h1>
          <p className="text-gray-600 mt-2">Verify your account to access all features and start trading</p>
        </div>
      </div>
